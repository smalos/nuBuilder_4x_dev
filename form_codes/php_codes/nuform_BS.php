...
if ('#sfo_type#' == '') {
    nuDisplayError('<b>Type</b> Cannot Be Blank..', 'sfo_type');
}
if ('#sfo_description#' == '') {
    nuDisplayError('<b>Description</b> Cannot Be Blank..', 'sfo_description');
}
...
if ($o == 'browseedit' || $o == 'subform' || $o == 'browse') {
    ...
    if ('#sfo_browse_sql#' == '') {
        nuDisplayError('<b>Browse SQL</b> Cannot Be Blank..', 'sfo_browse_sql');
    }
}
...
if ($o != 'launch') {
    if ('#sfo_table#' == '') {
        nuDisplayError('<b>Table Name</b> Cannot Be Blank..', 'sfo_table');
    }
    if ('#sfo_primary_key#' == '') {
        nuDisplayError('<b>Primary Key</b> Cannot Be Blank..', 'sfo_primary_key');
    }
}
