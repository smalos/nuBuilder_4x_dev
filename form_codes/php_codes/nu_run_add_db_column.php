...
if ($r == 0) {
    $js = "nuMessage(nuTranslate('Information'), nuTranslate('The column has been created successfully')); nuRefreshSelectObject('sql_after_column'); parent.nuUpdateMessage('refresh_required');";
}
else if ($r == - 1) {
